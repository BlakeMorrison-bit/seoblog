...
const ResetPassword = ({ router }) => {
    ...
    // grab new password from Password Reset Form below, and grab resetPasswordLink from router.
    const handleSubmit = e => {
        e.preventDefault();
        resetPassword({
            newPassword,
            resetPasswordLink: router.query.id // grab password link from router, called id because of file name
        }).then(data => {
            if (data.error) {
