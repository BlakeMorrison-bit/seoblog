...
// When you type something in the search bar it is avaible in search prop
// then sent to backend
// then pushed to results array
// rendered based off those results
...
const Search = () => {
    ...
    // Will make the user search query avaiable in the state.
